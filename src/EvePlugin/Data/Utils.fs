module KPX.EvePlugin.Data.Utils
...
let internal GetEveDataArchive () =
    let s = EmbeddedResource.GetResFileStream("EvePlugin.EVEData.zip")
    new Compression.ZipArchive(s, Compression.ZipArchiveMode.Read)
